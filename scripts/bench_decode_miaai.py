#!/usr/bin/env python3
"""Vendored from MiaAI-Lab/GLM-5.3-Flash-EXL3-2x-DGX-Sparks tests/bench_decode.py
(commit a93d983) with BASE/MODEL made env-configurable for cross-stack comparability.

Original docstring: Streaming decode bench + coherence probes.
